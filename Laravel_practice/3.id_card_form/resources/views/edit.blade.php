                ...
                <div class="col-md-5 form offset-md-3 mt-md-5 mb-md-5 rounded-3">
                    ...
                    <div class="row my-3">
                        <div class="col-md-6 mt-3">
                            <input type="text" name="fname" class="form-control form-control-sm " value="{{$data->fname}}" placeholder="First name" aria-label="First name" />
                        </div>
                        <div class="col-md-6 mt-3 ">
                            <input type="text" name="lname" class="form-control form-control-sm  " value="{{$data->lname}}" placeholder="last name" aria-label="last name" />
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col-md-12">
                            <input type="text" class="form-control form-control-sm" name="fthname" value="{{$data->fthname}}" placeholder="Father name" aria-label="Father name" />
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="idnum" name="idnum" type="text" class="form-control form-control-sm" value="{{$data->id}}" placeholder=" XXXXX-XXXXXXX-X" aria-label=" Identity Number" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="dob" class="form-label text-light">Date of Birth</label>
                            <input id="dob" type="date" name="dob" class="form-control form-control-sm" value="{{$data->dob}}" placeholder="Date of Birth" aria-label="Date of Birth" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input id="issue" type="date" name="idate" class="form-control form-control-sm" value="{{$data->idate}}" placeholder="issue date" aria-label="issue date" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="expirey" class="form-label text-light">Expirey Date</label>
                            <input id="expirey" type="date" name="exdate" class="form-control form-control-sm" value="{{$data->exdate}}" placeholder="expirey date" aria-label="expirey date" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-5  offset-md-3 rounded-3 form">
                    <div class="row">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <input type="text" class="form-control" name="paddress" id="paddress" value="{{$data->paddress}}" placeholder="Permanent Address" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <label for="taddress" class="form-label text-light">Temporary Address</label>
                            <input type="text" class="form-control" name="taddress" id="taddress" value="{{$data->taddress}}" placeholder="Temporary Address" />
                        </div>
                    </div>
