...
<head>
    <meta charset="utf-8">
    <title>Barcelona Grill - Bootstrap Restaurant Template</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>Barcelona Grill</h1>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Barcelona Grill</h1>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">72
                                    </h1>
                                    <div class="ps-4">
                                        <p class="mb-0">Months of</p>
        ...
        <div class="container-xxl py-5" id="menu">
            <div class="container">
                ...
                <div class="tab-class  wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a href="{{url('layout/'.$cat->slug)}}">
                        <div class="ps-3">
                            <img src="{{asset('/asset/catagory_img/'. $cat->catagory_img)}}" width="200px " class="mb-3" height="200px" alt="">
                            <small class="text-body">{{$cat->catagory_description}}</small>
                            <p class="mt-n1 fc mb-5 h3 mb-0 bg-dark py-3 w-50">{{$cat->catagory_name}}</p>
                        </div>
                    </a>
                    @endforeach
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="{{asset('/asset/img/'. $pro->img)}}" alt="" style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>{{ $pro->product }}</span>
                                                <span class="text-primary">{{ $pro->price }} $</span>
                                            </h5>
                                            <small class="fst-italic">{{ $pro->detail }}</small>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="req" placeholder="Special Request" id="message" style="height: 100px"></textarea>
